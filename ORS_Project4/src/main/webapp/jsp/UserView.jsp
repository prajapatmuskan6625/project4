			...
			<table>
				<tr>
					...
					<td><input type="text" name="firstName"
						placeholder="Enter First Name" onkeydown="return /[a-zA-Z]/i.test(event.key)" maxlength="20" size="25"
				...
				<tr>
					...
					<td><input type="text" name="lastName"
						placeholder="Enter Last Name" onkeydown="return /[a-zA-Z]/i.test(event.key)" maxlength="20" size="25"
				...
				<tr>
					...
					<td><input type="text" style="width: 202px" name="mobileNo"
						maxlength="10" placeholder="Enter Mobile No"  oninput="validateMobileNo(event)" name="mobile" maxlength="10" size="23"
