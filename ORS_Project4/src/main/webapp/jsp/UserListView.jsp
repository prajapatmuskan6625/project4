...
<body>
	...
	<form action="<%=ORSView.USER_LIST_CTL%>" method="post">
		...
		<center>
			...
			<%
			// List dlist= (List) request.getAttribute("List");
			...
			<table width="100%" align="center">
				<tr>
					...
					</label> <input type="text" name="firstName" placeholder="Enter First Name"onke
					ydown="return /[a-zA-Z]/i.test(event.key)" maxlength="20"
